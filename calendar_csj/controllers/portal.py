...
########## ##TRADUCIÓN TIPO AUDIENCIA ###################
                ...
                sheet.write('S'+str(row), appointment.room_id_mame.upper(), cell_format)
                ...
                sheet.write('AF'+str(row), appointment.state_description.upper() if appointment.state_description else '', cell_format)
